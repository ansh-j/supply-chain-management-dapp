...
const ContractAddress = "0x118002AB48eb3b524d2b6663d1B1D9BDDF32e15E";
...
export const TrackingProvider = ({ children }) => {
  ...
  const getAllShipment = async () => {
    try {
      ...
      const provider = new ethers.providers.JsonRpcProvider("https://sepolia.infura.io/v3/4229270ff76a4062a0e492d0e0047fcc");
